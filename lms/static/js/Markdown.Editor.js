...
(function() {
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions, imageUploadHandler) {
        ...
        function makeSpritedButtonRow() {
            ...
            buttonRow.setAttribute('aria-label', 'Text Editor');
            ...
            makeSpacer(1);
            buttons.link = makeButton('wmd-link-button', gettext('Hyperlink (Ctrl+L)'), '-40px', bindCommand(function(chunk) {
            ...
            buttons.image = makeButton('wmd-image-button', gettext('Image (Ctrl+G)'), '-100px', bindCommand(function(chunk) {
                return this.doLinkOrImage(chunk, postProcessing, true, imageUploadHandler);
            }), -1);
            makeSpacer(2);
            buttons.olist = makeButton('wmd-olist-button', gettext('Numbered List (Ctrl+O)'), '-120px', bindCommand(function(chunk) {
